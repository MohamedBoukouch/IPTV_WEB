    ...
    <div className='mr-0'>
      ...
      <div className=' sm:mr-48 sm:ml-48 mt-16'>
            ...
            {Container({
                ...
                reponse:"A minimum internet speed of 10Mbps is recommended for the standard streaming but if you want to stream 4K content then you will need 25 Mbps internet speed.",
            })}
            {Container({
                question:"How many devices can I use at once with my subscription?",
                reponse:"The standard subscription at StreamTVUniverse allows you to watch on up to 1 device simultaneously. For more IPTV Connections, please check our Multiple Connections Service on the Pricing page or contact us via WhatsApp for premium plans available.",
            })}
            {Container({
                question:"What devices can I use for IPTV?",
                reponse:"Our IPTV service is compatible with Smart TVs, streaming devices (Amazon Firestick, Roku, Apple TV), computers, tablets, Android, smartphones and more...",
            })}
            {Container({
            ...
            {Container({
                ...
                reponse:"You can Enjoy our IPTV Subscription Service in the USA, UK, Australia, Canada, France, Belgium, Switzerland, Spain, Portugal, Italy, Germany, the Netherlands, Arabic regions, Latin America, Turkey, and more.",
            })}
            {Container({
                question:"Can I cancel my subscription at any time?",
                reponse:"Yes, you can easily cancel the subscription plan at any time without any further cancellation fees. Simply follow the cancellation directions on the website or contact the support team for help.",
            })}
        </div>
    </div>
  );
